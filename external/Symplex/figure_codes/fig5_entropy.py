...
# result = get_mol_grid_special(n = len(composition), central_point=central_point, special_points=None, mol_gradation = 15)
# result = get_mol_grid_special(n = len(composition), central_point=central_point, special_points=None, mol_gradation = 15)
...
mol_grid = main(composition=composition,
                ...
                special_points=None)
plt.savefig("./fig5_revised2_entropy.png", dpi = 200)
